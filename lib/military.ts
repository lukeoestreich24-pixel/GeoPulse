// lib/military.ts
// All geopolitical/conflict data — conflict zones, country status,
// military bases, and live military aircraft (via server-side proxy)
...
// ── Country-level conflict/political stress status (ISO2) ─────────────────────
// Used to drive the choropleth on the geopolitical tab
export const COUNTRY_CONFLICT_STATUS: Record<string, ConflictStatus> = {
  ...
  // High tension — active military posturing, severe sanctions, near-conflict
  CN: "high-tension", KP: "high-tension", IR: "high-tension",
  TW: "high-tension", VE: "high-tension", BY: "high-tension",
  RS: "high-tension", KO: "high-tension", GE: "high-tension",
  AM: "high-tension", AZ: "high-tension", PK: "high-tension",
  IN: "high-tension", TD: "high-tension", HT: "high-tension",
  LB: "high-tension", BA: "high-tension", XK: "high-tension",

  // Occupation / disputed territory / frozen conflicts
  GE: "occupation", MD: "occupation", CY: "occupation",
  ER: "occupation", ZW: "occupation",

  // Heavily sanctioned / internationally isolated
  CU: "sanctioned", KP: "sanctioned",
};
...
// ── Conflict zone overlay rectangles ─────────────────────────────────────────
export const CONFLICT_ZONES: ConflictZone[] = [
  ...
  { id: "sahel",           name: "Sahel Insurgency",      status: "active-war",    description: "Jihadist insurgencies — Mali, Burkina Faso, Niger.",                   bounds: [10.0, -6.0, 21.0, 16.0],   color: "#ef4444" },
...
// ── Live military aircraft — fetched via /api/military-aircraft proxy ─────────
